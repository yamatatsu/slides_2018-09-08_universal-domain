...
<CodeSurfer
  ...
  // showNumbers
  steps={[
    { ranges: [[4,16]], notes: 'redux-thunkを使ってusecaseを書く' },
    { ranges: [[4,16]], notes: 'domain clientでもある' },
    { lines: [5,12,14], notes: 'usecaseのライフサイクルイベントを発行する' },
    { lines: [5,12,14], notes: 'REQUESTEDでgaやloadingが反応する' },
    { lines: [5,12,14], notes: 'SUCCEEDEDでサーバー登録などが反応する' },
    { lines: [5,12,14], notes: 'FAILEDでalertやトーストが反応する' },
